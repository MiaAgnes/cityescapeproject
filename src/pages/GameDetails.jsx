  ...
  return (
    <Layout bgClass="subpage-bg">
      ...
      <main className="grid place-items-center px-6 pt-4 pb-10 w-full">
        ...
        <div className="w-full max-w-lg grid grid-cols-1 justify-items-center gap-4 text-center -mt-6">
          {/* Game Icon */}
          <img
            src={game.icon}
            alt={game.title}
          ...
          <div className="w-fill grid grid-cols-3 justify-items-center mt-2">
            {/* Icons */}
            <img
            ...
            {/* Text */}
            <span className="text-[#C9955D] text-xs sm:text-sm font-secondary">
              {game.duration}
            </span>
            <span className="text-[#C9955D] text-xs sm:text-sm font-secondary">
              {game.participants}
          ...
          {/* Success Rate */}
          <div className="w-full mt-2 px-2 grid gap-1">
            <div className="grid grid-cols-2 text-[#C9955D] text-xs sm:text-sm font-primary">
